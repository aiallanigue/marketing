...
//		 echo '<br>' . $query;
	...
	public function save($data) {
		...
		$query = $this->wpdb->prepare(" " . $this->inventory_table . " SET 
			...
			$inventory_number, $inventory_name, $inventory_description, 
			$inventory_size, $inventory_manufacturer, $inventory_make,
			$inventory_model, $inventory_year, $inventory_serial,
			$inventory_fob, $inventory_quantity, $inventory_quantity_reserved,
			$inventory_price, $inventory_status, $inventory_slug, 
			$inventory_sort_order, $category_id, $now);
