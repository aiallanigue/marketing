...
class WPInventory_Categories_Widget extends WP_Widget {
	function WPInventory_Categories_Widget() {
		parent::WP_Widget('WPInventory_Categories_Widget', 'WP Inventory Categories', array('description'=>'List Inventory categories, with link(s) to view inventory for each category'));
	}
	...
	function form($instance) {
		...
		$display_as_select = WPIMCore::dropdown_array($this->get_field_name('display_as'), $instance['display_as'], array('list'	=> WPIMCore::__('List'), 'select'	=> WPIMCore::__('Dropdown')));
		$sort_order_select = WPIMCore::dropdown_array($this->get_field_name('sort_order'), $instance['sort_order'], array('sort_order'	=> WPIMCore::__('Sort Order'), 'category_name'	=> WPIMCore::__('Category Name')));
...
class WPInventory_Latest_Items_Widget extends WP_Widget {
	function WPInventory_Latest_Items_Widget() {
		parent::WP_Widget('WPInventory_Latest_Items_Widget', 'WP Inventory Latest Items', array('description'=>'List the latest items added to inventory.'));
	}
